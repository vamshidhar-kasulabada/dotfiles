-- start of lsp setup
-- [[ prerequisites
-- 1. Install Java 21 and set the JAVA_21 environment variable to the path
--    of the Java 21 executable.
-- 2. Install jdtls using Mason.nvim or manually.
-- ]]
local os_name = vim.loop.os_uname().sysname -- 'Windows_NT', 'Linux', 'Darwin'
...
local config = {
    cmd = {
        ...
        "-configuration",
        nvim_app_data_dir .. "/mason/packages/jdtls/config_" .. os_name,
        "-data",
        workspace_dir,
    },
